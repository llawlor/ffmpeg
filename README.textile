...
gem 'ffmpeg', :git => 'git://github.com/llawlor/ffmpeg.git'

h2. Usage

To build and execute a command you would use the FFMpeg::convert method like this:
...
<span>&nbsp;&nbsp;&nbsp;&nbsp;video_duration "00:10:01"</span>
end
